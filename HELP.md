...
* The original package name 'pl.poznan.put.cs.net.restapiexample.restapi-example' is invalid and this project uses 'pl.poznan.put.cs.net.restapiexample.restapiexample' instead.
